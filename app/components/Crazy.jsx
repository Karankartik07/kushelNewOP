          ...
          <div className="side-bg-trio">
            ...
            <div className="second-service-conte">
              ...
              <div className="main-img-mighty">
                ...
                <div className="bepolo">
                  <img
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1741002825/Group_1000004716_ca5ind.png"
                    id="qa-safari"
                    alt="img"
                  ></img>
            ...
            <SplideSlide>
              <div className="other-card">
                <div className="other-box">
                  <img
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1739163172/rel1_nqyk1x.png"
                    alt="rel1"
                  />
                </div>
            ...
            <SplideSlide>
              <div className="other-card">
                <div className="other-box other-box1">
                  <img
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1739163216/rel2_nrjco0.png"
                    alt="rel1"
                  />
                </div>
                <div className="other-tox-para">
            ...
            <SplideSlide>
              <div className="other-card">
                <div className="other-box other-box3">
                  <img
                    className="rel3"
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1739163252/rel3_taz3o0.png"
                    alt="rel1"
                  />
                </div>
                <div className="other-tox-para">
