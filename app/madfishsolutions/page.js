            ...
            <div className="case1fifirco">
              ...
              <div className="btn-caseG">
                <p className="ca1firrigh">
                  MadFish is a sustainable and elegant brand that delivers
                  comfort and warmth with its Cashmere Scarves. The brand is
                  committed to creating them through expert craftsmanship,
                  blending traditional techniques with technology for optimal
                  results.{" "}
                </p>
                <Link
