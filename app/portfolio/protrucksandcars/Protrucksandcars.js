...
const ProTrucks = () => {
  ...
  const generateMetadata = ({ params }) => ({
    title:
      "Pro Trucks and Cars | Ecommerce Growth with BigCommerce Website Development",
    description:
      "See how Pro Trucks and Cars boosted online sales with Kushel Digi Solutions custom BigCommerce website development services. Real results in this case study.",
  });
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.kusheldigi.com/protrucksandcars"
        />
      </Head>
      ...
      <div className="ser-main">
          ...
          <div className="side-bg-trio">
            <div className="first-kick-pads1">
              <div className="left-section-kids">
                <img
                  src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740472140/pru_yxgfwt.png"
                  className="pru"
                  alt="protrucksandcars logo"
                ></img>
                ...
                <div className="main-box-logic flex">
                  <img
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740472204/opqweeeeeee_cu9os9.png"
                    id="sim"
                    alt="img"
                  ></img>
                  <img
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740472246/opqweeeeeee2_h8sne3.png"
                    id="rotat"
                    alt="img"
                  ></img>
                </div>
              ...
              <div className="right-section-kids">
                <img
                  src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471895/pro-trucks-s_lpnj4a.png"
                  id="total-group"
              ...
              <div className="MadFish-back">
                <div className="MadFish-back1">
                  <div className="MadFish_press_head">
                    <img
                      src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740472327/madlogooooo_ujlity.png"
                      alt="madlogooooo"
                    />
                  </div>
                ...
                <div className="MadFish-back2">
                  <img
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740472364/mad2_yqpzdu.png"
                    alt="MadFish"
                  />
                </div>
              </div>
            ...
            <div className="second-service-conte">
              ...
              <div className="main-img-mighty">
                <div className="bepolo">
                  <img
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471802/Group_1000004718_lmr8qb.png"
                    id="ux-safari"
                    alt="img"
                  ></img>
                ...
                <div className="bepolo">
                  <img
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471834/Group_1000004715_scfvbs.png"
                    id="web-safari"
                    alt="img"
                  ></img>
                ...
                <div className="bepolo">
                  <img
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471863/Group_1000004716_crcvh6.png"
                    id="qa-safari"
                    alt="img"
                  ></img>
          ...
          <div className="inner-third-local-PRO-TRUCKS">
            ...
            <div className="three-section-lab-PRO-TRUCKS">
              <div className="single_big-PRO-TRUCKS">
                <img
                  src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471993/mnop1_weym0u.png"
                  id="pads-cats"
                  alt="img"
                ></img>
              </div>
        ...
        <div className="fourth-plate-juuls">
          <div className="left-card-hub">
            <div className="vl-chic">
              ...
              <div className="sub-worm">
                ...
                <img
                  src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471932/Group_1000006500_1_iwrrru.png"
                  id="pals-circle"
                  alt="img"
                ></img>
              </div>
          ...
          <div className="right-card-omega">
            <p>Color Plate</p>
            <img
              src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471960/hh5_dhnp6b.png"
              id="gang"
              alt="img"
            />
          </div>
        ...
        <div className="azib prozib">
          <div className="azib1">
            <div className="azib1-sect">
              ...
              <div className="azib1-second">
                ...
                <div className="azib-tech">
                  ...
                  <img
                    className="conjun"
                    src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740472284/opqweeeeeee3_kgmddp.png"
                    alt="conjun"
                  />
                </div>
              </div>
            ...
            <div className="azib-images flex items-center justify-center">
              <img
                src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471744/pt5_laoigm.jpg"
                alt="pt4"
              />
              <img
                src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471772/pt6_acyz4q.jpg"
                alt="pt5"
              />
              <img
                src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1740471716/pt4_c1gon0.jpg"
                alt="pt6"
              />
            </div>
          </div>
